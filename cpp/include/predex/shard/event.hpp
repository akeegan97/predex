...
namespace predex::shard{
    ...
    struct BookInvalidationResult {
        ...
        InvalidationRejectReason reject_reason{
    ...
    class Event{
        public:
            ...
            [[nodiscard]] std::optional<strategy::MonotonicPairObservation>build_monotonic_pair_observation(
                std::uint32_t easier_market_index,
                const strategy::StrategyObservationContext& context
            ) const noexcept;
