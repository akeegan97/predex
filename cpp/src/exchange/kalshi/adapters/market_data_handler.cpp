...
std::string KalshiMarketDataHandler::name() const { return "kalshi_market_data_handler"; }
...
std::string
KalshiMarketDataHandler::build_subscribe_message(std::uint64_t req_id,
                                                 KalshiMarketDataChannel channel,
                                                 std::span<const std::string> tickers) const {
...
// NOLINTNEXTLINE
std::string KalshiMarketDataHandler::build_update_message(std::uint64_t req_id,
...
std::string KalshiMarketDataHandler::build_unsubscribe_message(
    std::uint64_t req_id, std::span<const std::int64_t> session_ids) const {
    nlohmann::json params{
        {"sids", session_ids},
    };
