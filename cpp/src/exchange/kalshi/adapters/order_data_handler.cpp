...
std::string KalshiOrderDataHandler::name() const { return "kalshi_order_data_handler"; }
...
std::string
KalshiOrderDataHandler::build_subscribe_message(std::uint64_t req_id,
                                                KalshiOrderDataChannel channel,
...
std::string
KalshiOrderDataHandler::build_unsubscribe_message(std::uint64_t req_id,
                                                  KalshiOrderDataChannel channel,
                                                  std::span<const std::int64_t> session_ids) const {
    nlohmann::json params{{"channels", {channel_to_string(channel)}}};
