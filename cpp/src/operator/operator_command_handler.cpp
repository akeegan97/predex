            ...
            if constexpr (std::is_same_v<T, predex::operator_admin::AckPayload>){
                ...
                json_response["payload"] = {
                    ...
                    {"oms_stats", {
                        ...
                        {"portfolio_reconciliations_requested", payload.oms_stats.portfolio_reconciliations_requested},
                        {"portfolio_reconciliations_completed", payload.oms_stats.portfolio_reconciliations_completed},
                        {"portfolio_reconciliations_failed", payload.oms_stats.portfolio_reconciliations_failed},
                        {"duplicate_fills_ignored", payload.oms_stats.duplicate_fills_ignored},
                        {"venue_position_updates_seen", payload.oms_stats.venue_position_updates_seen},
                        {"venue_available_balance_ticks", payload.oms_stats.venue_available_balance_ticks},
                        ...
                        {"execution_incidents_latched", payload.oms_stats.execution_incidents_latched},
                        {"group_repair_attempts", payload.oms_stats.group_repair_attempts},
                        {"group_repair_commands_sent", payload.oms_stats.group_repair_commands_sent},
                    ...
                    {"order_rest_stats", {
                        ...
                        {"last_portfolio_reconciliation_error", payload.order_rest_stats.last_portfolio_reconciliation_error},
